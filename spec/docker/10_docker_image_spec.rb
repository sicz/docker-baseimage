...
describe "Docker image", :test => :docker_image do
  ...
  describe "Files" do
    ...
    files = [
      ...
      ["/docker-entrypoint.d/35-environment-certs.sh",    644, "root", "root", [:be_file, :eq_sha256sum]],
      ["/docker-entrypoint.d/40-simple-ca-cert.sh",       644, "root", "root", [:be_file, :eq_sha256sum]],
      ["/docker-entrypoint.d/45-trusted-ca-cert.sh",      644, "root", "root", [:be_file, :eq_sha256sum]],
      ["/docker-entrypoint.d/46-server-cert.sh",          644, "root", "root", [:be_file, :eq_sha256sum]],
      ["/docker-entrypoint.d/47-server-pkcs12.sh",        644, "root", "root", [:be_file, :eq_sha256sum]],
